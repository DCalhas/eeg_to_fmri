...
l1_reg = tf.keras.regularizers.l1
...
class Multi_Modal_Model:
	...
	def build_eeg(self, input_shape, output_shape, regularization=0.0, activation='tanh', dropout=0.0):
	...
	def build_bold(self, input_shape, output_shape, regularization=0.0, activation='tanh', dropout=0.0):
	...
	def build_decoder(self, input_shape, output_shape, regularization=0.0, activation='tanh', dropout=0.0):
...
class Neural_Architecture:
	...
	#
	#######################################################################################################################
	def build_net(self, input_shape, hidden_output_shape, previous_model=None, regularization=0.0, activation='tanh', dropout=0.0, verbose=False):
...
class Iterative_Naive_NAS:
	...
	def build_layer_Dense(self, input_shape, output_shape, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
	...
	def build_layer_Conv2D(self, input_shape, output_shape, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
		generated = self.generate_kernel_stride_Conv2D(input_shape, output_shape)

		if(not generated):
			return None

		return [layers[1](1, kernel_size=generated['kernel'], 
							activation=activation,
	...
	def build_layer_Conv2DTranspose(self, input_shape, output_shape, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
	...
	def build_layer_UpSampling2D(self, input_shape, output_shape, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
	...
	def build_layer_Conv3D(self, input_shape, output_shape, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
		generated = self.generate_kernel_stride_Conv3D(input_shape, output_shape)

		if(not generated):
			return None

		return [layers[3](1, kernel_size=generated['kernel'], 
							activation=activation,
							strides=generated['stride'], 
							input_shape=input_shape, 
							kernel_regularizer=l1_reg(regularization), 
	...
	def build_layer_Conv3DTranspose(self, input_shape, output_shape, next_input_shape=None, regularization=0.0, activation='tanh', initializer=tf.keras.initializers.Constant(value=0.5)):
