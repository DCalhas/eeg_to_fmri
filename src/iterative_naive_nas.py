...
class Multi_Modal_Model:
	...
	def build_bold(self, input_shape, output_shape, regularization=0.0, activation='linear', dropout=0.0):
	...
	def build_decoder(self, input_shape, output_shape, regularization=0.0, activation='linear', dropout=0.0):
...
class Neural_Architecture:
	...
	#
	#######################################################################################################################
	def build_net(self, input_shape, hidden_output_shape, previous_model=None, regularization=0.0, activation='linear', dropout=0.0, verbose=False):
