...
def entropy_mae_loss(y_true, y_pred):
    ...
    classification = (1/y_pred[4])*tf.reduce_mean(tf.math.square(y_true-y_pred[0]), axis=(1,2,3))#tf.keras.losses.CategoricalCrossentropy(from_logits=True)(y_true, y_pred[0]) 
